'''
Author: xiaoniu
Date: 2026-01-10 22:25:37
LastEditors: xiaoniu
LastEditTime: 2026-01-12 23:39:46
Description: 文件用途描述
'''
import torch
from torch import nn
from utils import get_earth_position_index
...
class EarthAttention3D(nn.Module):
    ...
    def __init__(
        ...
        )  # Wpl**2 * Wlat**2 * Wlon*2-1, Npl//Wpl * Nlat//Wlat, nH (4*36*23, 4*31, num_heads)
